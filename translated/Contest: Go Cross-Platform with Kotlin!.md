...
大家好，
你有没有听说过RoboVM？它可以让您为iOS和Android创建美丽的本地应用程序，从而允许您在平台之间共享代码。 RoboVM将Java字节码转换为本地ARM或x86代码。
最新的RoboVM版本使其与Kotlin起步和运行非常简单！今天你有很好的动力玩，参加第一次Kotlin Mobile比赛！只需安装IntelliJ IDEA的RoboVM插件或下载RoboVM Studio，并创建一个跨平台Kotlin应用程序。
## 如何进入
...
没有Mac的iOS开发？没问题 - 我们也接受Android应用程式！ IntelliJ IDEA Ultimate和Community Edition都非常支持在Windows和Linux上使用Kotlin构建Android应用程序！此外，如果您不是RoboVM客户，请注意，您可以使用RoboVM的免费30天试用版进入比赛。您不需要进行任何购买。
## 
如何取胜
...
所有应用程序必须在2015年12月14日之前的PST日期提交！ RoboVM和JetBrains的团队将从所有提交中挑选获奖者。有效的条目包括您的推文指向您的应用程序的GitHub信息库。每个参与者和每个GitHub资料库只能获得一个奖项。跨平台应用程序的积分，我们将高兴推广的tweet或博客帖子的开发日志，以及代码质量！获奖者将在RoboVM和Kotlin博客以及Twitter上公布，并将通过GitHub联系。
没有Kotlin经验？在Slack上加入800多个社区成员，并提出问题！
祝你好运！
