...
一段时间以来，我们中的一些人一直在开发一个名为Spek的项目，这个框架允许您编写可执行规范。它允许您以更人性化的方式编写规范（即测试），而且更重要的是描述性的方式，而无需使用长测试名称，下划线或正则表达式。

{% raw %}
<p><span id="more-1421"></span></p>
{% endraw %}

现在已经达到了其第一个里程碑，它足够适合开始在项目中使用，我们准备好反馈和功能要求！它甚至有自己的网站。
## 简要介绍
...
Spek允许您在相同的上下文中拥有多个动作。这是相同的，你可以有多个on。它也允许你对同一个动作有更多的断言（it）。
## 斯派克不仅仅是科特林
...
希望你喜欢你看到的东西，转到Spek网站了解更多。它仍然在“EAP”，所以报告的问题越多越好。而且由于它是OSS（Apache 2）的贡献，更受欢迎。
