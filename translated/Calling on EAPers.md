...
访问EAP的最简单方法是通过“工具”菜单。打开*工具| Kotlin |在主菜单中配置Kotlin插件更新*，选择早期访问预览频道1.0.x或1.1，然后按*检查更新*按钮。<br/>
