...
****This action allows you to surround a block of code with <em>if</em>, <em>try</em> or other statements (see [the full list](#full_list) bellow). Simply select a block of code, press <em>Ctrl + Alt + T</em> and choose the template (<em>Cmd + Alt + T</em> for Mac):<span id="more-868"></span>
